                    ...
                    <table class="table table-bordered table-hover dataTable dtr-inline">
                        ...
                        <tbody>
                            @forelse($users as $key => $row)
                                <tr>
                                    <td><input type="checkbox" name="checkName" wire:model="selectedUsers.{{$row->id}}"></td>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $row->name }}</td>
                                    <td>{{ $row->account }}</td>
                                    <td>{{ $row->phone }}</td>
                        ...
                        <table class="table table-bordered table-hover dataTable dtr-inline">
                            ...
                            <tbody>
                                @forelse($permissions as $key => $row)
                                    <tr>
                                        <td><input type="checkbox" name="checkName" wire:model="selectedPermissions.{{$row->id}}"></td>
                                        <td>{{ $key+1 }}</td>
                                        <td>{{ $row['name'] }}</td>
                                    </tr>
                                @empty
