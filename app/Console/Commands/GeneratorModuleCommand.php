...
// generateController start
    ...
    protected function routeView(){
        return 'admin.'.$this->arguments()['name'].'.index';
    }
...
// generateControllerLiveWire start
    ...
    public function getMessages(){
        ...
        return 'protected $messages = [' . PHP_EOL . $str  . '    ];' . PHP_EOL;
    }
    ...
    public function querySearchLiveWire(){
        ...
        $str .= '        $data = $query->orderBy($this->key_name,$this->sortingName)->paginate($this->perPage);';
        return $str;
    }
    ...
    public function getDestroyDataLivewire(){
        ...
        $str = '';
        $str .=  ucfirst($this->arguments()['name']).'::find($this->deleteId)->delete();';
        return $str;
    }
